...
Провайдеры use cases связывает composition root (``bootstrap``) через
``dependency_overrides``; здесь только роутеры и обработчики ошибок.
"""

from fastapi import FastAPI

from catalog_service.presentation.api.errors import register_error_handlers
from catalog_service.presentation.api.routers import health, products
